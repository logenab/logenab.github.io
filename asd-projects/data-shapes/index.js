$(document).ready(function () {
  ...
  function handleGood(color,shape,repeats){
    setBackgroundWithSimple(color,shape,repeats);
  ...
  function goodDisplay() {
    ...
    // assining fuction created called handlegood to currentShape object useing dot notation.
  ...
  function badDisplay() {
    ...
    // calling handleBad fuction and assining currentshape array and repeat variable to it 
